...
{
   QMessageBox::warning(this, ("EXAMPLE"), "<P><FONT COLOR='#FFFFFF'>you didn't enter text</FONT></P>", QMessageBox::Close);
}
}
...
{
    QMessageBox::warning(this, ("EXAMPLE"), "<P><FONT COLOR='#FFFFFF'>please check for mistakes firstly</FONT></P>", QMessageBox::Close);}
}
...
void MainWindow::on_pushButton_4_clicked()
{
    ...
    {
        QMessageBox::warning(this, ("EXAMPLE"), "<P><FONT COLOR='#FFFFFF'>please check for the mistakes first</FONT></P>", QMessageBox::Close);
    }
